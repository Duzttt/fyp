...
const emit = defineEmits(['chunk-click', 'chunk-rightclick', 'suggestion-click'])

const chatBodyRef = ref(null)
const isNearBottom = ref(true)

const onChunkClick = (chunk) => emit('chunk-click', chunk)
const onChunkRightclick = (event, chunk) => emit('chunk-rightclick', event, chunk)
const onSuggestionClick = (questionText) => emit('suggestion-click', questionText)
  ...
  <div class="chat-body" ref="chatBodyRef" @scroll="checkScrollPosition">
    <div v-if="messages.length === 0" class="chat-empty">
      ...
      <div v-if="hasSelection" class="empty-suggestions">
        <QuestionSuggestions
          ...
          :centered="true"
          @question-select="onSuggestionClick"
        />
      </div>
    ...
    <div v-else class="messages-list">
      ...
      >
        <ChatMessage
          :message="msg"
          @chunk-click="onChunkClick"
          @chunk-rightclick="onChunkRightclick"
        />
      ...
      <div v-if="isLoading" class="message-group">
        <div class="message assistant">
          ...
          <div class="message-content loading" aria-live="polite">
            <span>{{ isRetrieving ? 'Searching knowledge base' : 'Generating answer' }}</span>
