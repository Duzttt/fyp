import { Wifi, WifiOff, Settings, Share2, BarChart3, Plus } from 'lucide-react';
      ...
      <header className="h-[56px] px-4 sm:px-5 flex items-center justify-between border-b border-gray-800/80 bg-gradient-to-br from-[#020617] to-[#111827]">
        ...
        <div className="hidden md:flex items-center gap-2">
          ...
          <button
            ...
            className="h-8 px-3.5 rounded-full bg-[radial-gradient(circle_at_top_left,#020617,#111827)] border border-gray-700/90 text-gray-200 text-xs font-medium hover:bg-gray-800 transition-colors flex items-center gap-1.5 cursor-pointer"
          >
        ...
        <div className="flex items-center gap-2.5">
          <button
            onClick={() => setIsSettingsOpen(true)}
            className="md:hidden w-[26px] h-[26px] rounded-full border border-gray-700/90 bg-[#0f172a]/95 text-[#9ca3af] flex items-center justify-center hover:text-white transition-colors cursor-pointer"
          >
            <Settings className="w-3.5 h-3.5" />
          </button>
