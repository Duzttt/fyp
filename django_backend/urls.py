...
urlpatterns = [
    ...
    path("api/summary/jobs", views.summary_jobs),
    path("api/summary/jobs/", views.summary_jobs),
    path("api/summary/jobs/<str:job_id>", views.summary_job_detail),
    path("api/summary/jobs/<str:job_id>/", views.summary_job_detail),
    ...
    path("api/quiz/<str:quiz_id>/delete/", views.delete_quiz),
    # Flashcard endpoints
    path("api/flashcards/generate", views.generate_flashcards),
    path("api/flashcards/generate/", views.generate_flashcards),
    path("api/flashcards/history", views.get_flashcards_history),
    path("api/flashcards/history/", views.get_flashcards_history),
    path("api/flashcards/<str:deck_id>/delete", views.delete_flashcards),
    path("api/flashcards/<str:deck_id>/delete/", views.delete_flashcards),
    # LLM Monitoring
